...
START_TEST(negative_zero) {
  ...
  CODEERROR = s21_truncate(val1, &result);
...
START_TEST(truncate_broken_decimal_empty_fields_is_not_empty) {
  s21_decimal val1 = {0};
  val1.bits[0] = 14563;
  val1.bits[1] = 0;
  val1.bits[2] = 0;
...
START_TEST(truncate_broken_decimal_empty_fields_is_not_empty_n2) {
  s21_decimal val1 = {0};
  val1.bits[0] = 14563;
  val1.bits[1] = 0;
  val1.bits[2] = 0;
...
START_TEST(truncate_broken_decimal_too_big_power) {
  s21_decimal val1 = {0};
  val1.bits[0] = 14563;
  val1.bits[1] = 0;
  val1.bits[2] = 0;
...
Suite *suite_truncate(void) {
  ...
  tcase_add_test(tc, truncate_broken_decimal_empty_fields_is_not_empty);
  tcase_add_test(tc, truncate_broken_decimal_empty_fields_is_not_empty_n2);
  tcase_add_test(tc, truncate_broken_decimal_too_big_power);
