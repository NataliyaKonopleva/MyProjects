...
START_TEST(floor_positive) {
  ...
  CODEERROR = s21_floor(val1, &result);
...
START_TEST(floor_negative_zero) {
  s21_decimal val1 = {0};
  val1.bits[0] = 0;
  val1.bits[1] = 0;
  val1.bits[2] = 0;
...
START_TEST(floor_positive_downside) {
  s21_decimal val1 = {0};
  val1.bits[0] = 53213;
  val1.bits[1] = 0;
  val1.bits[2] = 0;
...
START_TEST(floor_negative_downside) {
  s21_decimal val1 = {0};
  val1.bits[0] = 4567;
  val1.bits[1] = 0;
  val1.bits[2] = 0;
...
START_TEST(floor_positive_zeroresult) {
  s21_decimal val1 = {0};
  val1.bits[0] = 4567;
  val1.bits[1] = 0;
  val1.bits[2] = 0;
...
START_TEST(floor_broken_decimal_empty_fields_is_not_empty) {
  s21_decimal val1 = {0};
  val1.bits[0] = 14563;
  val1.bits[1] = 0;
  val1.bits[2] = 0;
...
START_TEST(floor_broken_decimal_empty_fields_is_not_empty_n2) {
  s21_decimal val1 = {0};
  val1.bits[0] = 14563;
  val1.bits[1] = 0;
  val1.bits[2] = 0;
...
START_TEST(floor_broken_decimal_too_big_power) {
  s21_decimal val1 = {0};
  val1.bits[0] = 14563;
  val1.bits[1] = 0;
  val1.bits[2] = 0;
...
Suite *suite_floor(void) {
  ...
  tcase_add_test(tc, floor_broken_decimal_empty_fields_is_not_empty);
  tcase_add_test(tc, floor_broken_decimal_empty_fields_is_not_empty_n2);
  tcase_add_test(tc, floor_broken_decimal_too_big_power);
  tcase_add_test(tc, floor_positive_downside);
  tcase_add_test(tc, floor_negative_downside);
  tcase_add_test(tc, floor_zero);
  tcase_add_test(tc, floor_positive_zeroresult);
  tcase_add_test(tc, floor_negative_one);
  tcase_add_test(tc, floor_negative_zero);
